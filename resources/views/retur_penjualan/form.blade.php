                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line focused">
                                <input type="text" class="form-control" name="no_penjualan" @if(isset($datas)) value="{{ $datas->no_penjualan }}" @else value="{{ "P-". date('Y')."".date('m')."".date('d')."".date("his") }}" @endif required>
                            </div>
                ...
                <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12 col-md-12">
                                ...
                                <div class="form-line">
                                    <select class="form-control" name="sale_id">
                                        @foreach($sales as $data)
                                            <option value="{{ $data->id }}" @if(isset($datas)) @if($data->id == $datas->nama_sales) selected @endif @endif>{{ $data->nama_sales }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="keterangan" class="form-control" placeholder="Keterangan" @if(isset($datas)) value='{{$datas->keterangan}}' @endif required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            @if(isset($datas->detail))
                                @foreach($datas->detail as $d)
                                    <tr>
                                        ...
                                        <td class="subTotal">{{ number_format( $d->qty * ($d->item->harga_item)) }}</td>
