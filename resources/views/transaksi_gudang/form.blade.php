...
<div class="row clearfix">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="card">
            <div class="header">
                <a href="{{ route('transaksi_gudang.index') }}" class="btn btn-warning">Kembali</a>
            </div>
            <div class="body">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line focused">
                                <input type="text" class="form-control" name="no_pembelian" @if(isset($datas)) value="{{ $datas->no_pembelian }}" @else value="{{ "P-". date('Y')."".date('m')."".date('d')."".date("his") }}" @endif required>
                            </div>
