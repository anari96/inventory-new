            ...
            <div class="body">
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group colorpicker colorpicker-element">
                            <div class="form-line ">
                                <input type="text" class="form-control" readonly value="{{ $datas->grand_total }}">
                            </div>
                            <span class="input-group-addon">
                                <i style="background-color: rgb(0, 170, 187);"></i>
                            </span>
        ...
        <div class="card">
            ...
            <div class="body">
               ...
               <div class="row">
                    ...
                    <div class="col-md-4">
                        <p style="font-weight:bold;">Jumlah Pembayaran</p>
                    </div>
                </div>
                @forelse($pembayaran_services as $pembayaran_service)
                    <div class="row">
                        <div class="col-md-1">
                            {{$loop->index + 1}}.
                        </div>
                        <div class="col-md-2">
                            {{ date("Y-m-d",strtotime($pembayaran_service->created_at)) }}
                        </div>
                        <div class="col-md-4">
                            <p>Rp. {{ number_format($pembayaran_service->uang_bayar) }}</p>
                        </div>
