...
<div class="row clearfix">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="card">
            <div class="header">
                <a href="{{ route('pembayaran_hutang.index') }}" class="btn btn-warning">Kembali</a>
            </div>
            <div class="body">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="card">
            ...
            <div class="body">
                ...
                @forelse($pembayaran_hutangs as $pembayaran_hutang)
                    <div class="row">
                        <div class="col-md-4">
                            <p>Rp. {{ number_format($pembayaran_hutang->uang_bayar) }}</p>
                        </div>
